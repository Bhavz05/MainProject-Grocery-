...
public class ManageNewsPage {
	...
	public String isUserListed() {
		wait.waitUntilElementVisible(driver, searchResultTable); // To avoid assertion failure due to invisiblity of
																	// searchUser element
		return searchResultTable.getText();
	}

	/*
	 * public boolean checkNewsCreationSuccessAlertDisplayed() { WebDriverWait wait
	 * = new WebDriverWait(driver, Duration.ofSeconds(30));
	 * wait.until(ExpectedConditions.visibilityOf( newsCreationSuccessMsg)); return
	 * newsCreationSuccessMsg.isDisplayed(); }
	 */
